...
<?php
    ...
    if ( !empty($terms) ) {
        echo '
        <div id="visa" class="empty-block"></div>
    ...
    if ( $query->have_posts() ) {
        echo '
        <div id="country" class="empty-block"></div>
        <div class="container">
    ...
    if ( $query->have_posts() ) {
        echo '
        <div id="imigration" class="empty-block"></div>
        <div class="imigration-block">
    ...
    if ( $query->have_posts() ) {
        echo '
        <div id="team" class="empty-block"></div>
